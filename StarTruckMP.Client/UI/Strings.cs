...
internal static class Strings
{
    ...
    private static readonly Dictionary<string, string[]> Table = new()
    {
        ...
        ["display.nopause"] = new[] { "No pause while on a server:  ", "Без паузы на сервере:  ", "Keine Pause auf einem Server:  ", "Pas de pause sur un serveur :  ", "Sin pausa en un servidor:  ", "Sem pausa em um servidor:  ", "Bez pauzy na serwerze:  ", "Nessuna pausa su un server:  ", "在服务器上不暂停：", "在伺服器上不暫停：" },
        ["display.updates"] = new[] { "Check for updates:  ", "Проверять обновления:  ", "Nach Updates suchen:  ", "Vérifier les mises à jour :  ", "Buscar actualizaciones:  ", "Verificar atualizações:  ", "Sprawdzaj aktualizacje:  ", "Controlla aggiornamenti:  ", "检查更新：", "檢查更新：" },
