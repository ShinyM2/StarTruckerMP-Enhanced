...
Позиции идут с меткой времени отправителя. Копия рисуется там, где владелец был около 120 мс назад, между двумя реальными позициями вокруг этого момента, поэтому она движется так же плавно, как грузовик владельца, что бы сеть ни сделала с пакетами. В заголовке страницы мультиплеера на мониторе видны пинг, доля потерянных пакетов движения и эта задержка.
